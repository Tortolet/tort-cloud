                ...
                .authorizeHttpRequests((authz) -> {
                            try {
                                authz
                                        ...
                                        .requestMatchers(HttpMethod.GET, "/api/get_folders_uuid_shared/**", "/api/get_bytes_folder/**", "/api/download", "/api/get_folder_uuid/**", "/api/get_files_shared/**", "/api/get_bytes_file/**", "/api/view", "/api/download-file").permitAll()
